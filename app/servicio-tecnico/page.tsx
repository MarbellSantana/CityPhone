...
export default function ServicioTecnicoPage() {
  ...
  function fichaIngreso(r:Repair) {
    return `*CITY PHONE - SERVICIO TECNICO*\n*Ficha de ingreso para revision*\n\n*Orden:* ${orderNumber(r.id)}\n*Cliente:* ${r.nombre}${r.apellido ? ` ${r.apellido}` : ""}\n*Equipo:* ${r.equipo}\n*Motivo de ingreso:* ${r.motivo}\n*Estado:* Recibido para revision\n*Fecha:* ${new Date(r.createdAt).toLocaleDateString("es-AR")}\n\nEl equipo fue recibido para *revision y diagnostico*. Una vez revisado, te enviaremos el diagnostico y el presupuesto antes de realizar cualquier reparacion.\n\nAv. Corrientes 640 - Local 8\nGaleria Central\n\nGracias por confiar en *City Phone*.`;
  }
  function fichaDiagnostico(r:Repair) {
    return `*CITY PHONE - SERVICIO TECNICO*\n*Diagnostico y presupuesto*\n\n*Orden:* ${orderNumber(r.id)}\n*Cliente:* ${r.nombre}${r.apellido ? ` ${r.apellido}` : ""}\n*Equipo:* ${r.equipo}\n*Diagnostico:* ${r.diagnostico||"-"}\n*Reparacion recomendada:* ${r.reparacionRecomendada||"-"}\n*Presupuesto:* ${money.format(r.precio)}\n*Estado:* Esperando aprobacion\n\nPor favor indicanos por este medio si *aprobas la reparacion*. No realizaremos la reparacion hasta recibir tu confirmacion.\n\nAv. Corrientes 640 - Local 8\nGaleria Central\n\n*City Phone*`;
  }
  function fichaCotizacion(q:Quote) {
    return `*CITY PHONE - SERVICIO TECNICO*\n*Cotizacion*\n\n*Cliente:* ${q.cliente}\n*Equipo:* ${q.equipo}\n*Reparacion:* ${q.reparacion}\n*Precio:* ${money.format(q.precio)}\n*Estado:* Pendiente de aprobacion\n\nPor favor indicanos por este medio si *aprobas la cotizacion*.\n\nAv. Corrientes 640 - Local 8\nGaleria Central\n\n*City Phone*`;
  }
  ...
  function guardarCotizacion(event:FormEvent<HTMLFormElement>) {
    ...
    setQuotes(v => [q,...v]);
    if (enviarWhatsapp) whatsapp(q.telefono,fichaCotizacion(q));
