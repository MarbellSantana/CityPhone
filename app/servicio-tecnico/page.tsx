...
export default function ServicioTecnicoPage() {
  ...
  function fichaIngreso(r:Repair) {
    const fecha = new Date(r.createdAt).toLocaleDateString("es-AR");
    return `🟢 *CITY PHONE · SERVICIO TÉCNICO*\n*Ficha de ingreso al taller*\n\n🧾 *Orden:* ${orderNumber(r.id)}\n👤 *Cliente:* ${r.nombre}${r.apellido ? ` ${r.apellido}` : ""}\n📱 *Equipo:* ${r.equipo}\n🛠️ *Motivo:* ${r.motivo}\n💰 *Precio estimado:* ${money.format(r.precio)}\n📌 *Estado:* ${r.estado}\n📅 *Fecha:* ${fecha}\n\n📍 Av. Corrientes 640 · Local 8\nGalería Central\n\nGracias por confiar en *City Phone* 💚\nTe avisaremos por este medio cuando haya novedades sobre tu equipo.`;
  }
